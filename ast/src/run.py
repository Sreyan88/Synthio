...
parser.add_argument('--supcon', type=bool, default=False, help="which epoch to end weight averaging the checkpoint model")
...
if not os.path.isdir("%s/models" % args.exp_dir):
