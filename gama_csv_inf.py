...
def main(
    args,
    base_model: str = "/fs/nexus-projects/brain_project/acl_sk_24/ltu/src/Llama-2-7b-chat-hf-qformer",
    ...
    eval_mdl_path = './stage4_all_mix_new/checkpoint-46800/pytorch_model.bin'
    ...
    for i in tqdm(range(len(file))):
        ...
        tmp_label.append(file['label'][i])

    df = pd.DataFrame()
    df['path'] = tmp_path
    df['label'] = tmp_label
    df['dataset'] = tmp_dataset
    df['split_name'] = tmp_split_name
